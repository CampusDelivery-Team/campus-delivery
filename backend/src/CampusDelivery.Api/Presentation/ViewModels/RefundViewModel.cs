...
public sealed class RefundCreateViewModel
{
    ...
    [StringLength(180, ErrorMessage = "退款原因不能超过 180 个字符")]
    [Display(Name = "退款原因")]
...
{
    public List<RefundSummaryViewModel> Refunds { get; set; } = [];
...
public sealed class RefundReviewViewModel
{
    ...
    [Required(ErrorMessage = "请输入审核理由")]
    [StringLength(100, ErrorMessage = "审核理由不能超过 100 个字符")]
    [Display(Name = "审核理由")]
