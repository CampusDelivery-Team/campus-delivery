...
public interface IServiceTypeRepository
{
    ...
    Task<ServiceTypeRepositoryWriteResult> InsertAsync(ServiceType serviceType, CancellationToken cancellationToken = default);
    Task<ServiceTypeRepositoryWriteResult> UpdateAsync(ServiceType serviceType, CancellationToken cancellationToken = default);
...
public enum ServiceTypeRepositoryWriteResult
{
    Success,
    DuplicateName,
    NotFound
