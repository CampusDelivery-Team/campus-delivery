...
public interface IComplaintService
{
    ...
    Task<(IReadOnlyList<Complaint> Items, int TotalCount)> GetReceivedComplaintsAsync(int runnerId, int page, int pageSize, CancellationToken cancellationToken = default);
