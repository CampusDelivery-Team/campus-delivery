...
![1788239781413](image/TC-SETTLE-04-退款-投诉中支付不结算/1788239781413.png)
<!-- TODO: 如生成了结算单，放置结算详情中不包含该 payment_id 的截图 -->

可结算的订单中不包含退款、投诉中的订单
![1788240365434](image/TC-SETTLE-04-退款-投诉中支付不结算/1788240365434.png)

### SQL 截图

<!-- TODO: 放置退款或投诉测试数据查询截图 -->
![1788240564231](image/TC-SETTLE-04-退款-投诉中支付不结算/1788240564231.png)

![1788240590425](image/TC-SETTLE-04-退款-投诉中支付不结算/1788240590425.png)
<!-- TODO: 放置候选过滤 SQL 无结果截图 -->
![1788240644407](image/TC-SETTLE-04-退款-投诉中支付不结算/1788240644407.png)
<!-- TODO: 放置 settlement_payment_items 查询无结果截图 -->
![1788240668349](image/TC-SETTLE-04-退款-投诉中支付不结算/1788240668349.png)
